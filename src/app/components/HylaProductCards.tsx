  ...
  const products = [
    {
      ...
      hoverGradient: 'group-hover:from-blue-600/20 group-hover:to-cyan-500/20',
      ...
      <div className="container mx-auto px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {products.map((product, index) => (
            ...
            >
              <Link to={product.to} className="block group">
                <div className="relative bg-white rounded-[2rem] overflow-hidden border border-gray-100 hover:border-gray-200 transition-all duration-500 hover:shadow-2xl">
                  ...
                  <div className="relative h-[320px] md:h-[380px] overflow-hidden">
                    <div className={`absolute inset-0 bg-gradient-to-br ${product.gradient} ${product.hoverGradient} transition-all duration-500`} />
                      ...
                      <div className="absolute inset-0">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-full p-6">
                            <product.icon className="size-12 text-white" />
                          </div>
                        </div>
                      </div>
                    )}
                    ...
                    <div className="absolute top-6 left-6 z-20">
                      <div className={`${product.accentColor} text-white text-[10px] font-bold uppercase tracking-widest px-4 py-1.5 rounded-full`}>
                        {product.subtitle}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-8 md:p-10">
                    <div className="flex items-start justify-between mb-4">
                      <h3 className="text-3xl md:text-4xl font-bold tracking-tight">{product.title}</h3>
